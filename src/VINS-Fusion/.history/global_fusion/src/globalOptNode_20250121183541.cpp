...
double last_vio_t = -1;
std::queue<sensor_msgs::PoseStampedConstPtr> gpsQueue;
std::mutex m_buf;
...
void GPS_callback(const sensor_msgs::PoseStampedConstPtr &GPS_msg)
{
    //printf("gps_callback! \n");
    m_buf.lock();
...
void vio_callback(const nav_msgs::Odometry::ConstPtr &pose_msg)
{
    ...
    {
        sensor_msgs::PoseStampedConstPtr GPS_msg = gpsQueue.front();
