...
void pubLatestOdometry(const Eigen::Vector3d &P, const Eigen::Quaterniond &Q, const Eigen::Vector3d &V, double t)
{
    ...
    odometry.pose.pose.orientation.x = Q_new_latest.x();
    odometry.pose.pose.orientation.y = Q_new_latest.y();
    odometry.pose.pose.orientation.z = Q_new_latest.z();
    odometry.pose.pose.orientation.w = Q_new_latest.w();
