...
geometry_msgs::PoseStamped WorldToBodyTransformer::transformToBodyFrame(const geometry_msgs::PoseStamped& world_pose) {
    ...
    // Eigen::Quaterniond ned_orientation = TWfluWned * world_orientation.toRotationMatrix();
    // Eigen::Quaterniond body_orientation = TWfluWned * current_origin_orientation_.conjugate() * ned_orientation;
