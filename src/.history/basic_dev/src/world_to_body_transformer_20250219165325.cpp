...
//     Eigen::Quaternion Q(world_pose.pose.orientation.w, world_pose.pose.orientation.x, world_pose.pose.orientation.y, world_pose.pose.orientation.z);
//     Eigen::Matrix4d Twb = Eigen::Matrix4d::Identity();
//     Twb.block(0, 0, 3 ,3) = Q.normalized().toRotationMatrix();
//     Twb(0, 3) = world_pose.pose.position.x;
//     Twb(1, 3) = world_pose.pose.position.y;
//     Twb(2, 3) = world_pose.pose.position.z;
//     // 更新输出位姿
//     body_pose.pose.position.x = body_position.x();
//     body_pose.pose.position.y = body_position.y();
//     body_pose.pose.position.z = body_position.z();
