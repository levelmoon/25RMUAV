...
int main(int argc, char** argv)
{
    ...
    // ros::Subscriber odom_suber = n.subscribe<nav_msgs::Odometry>("/vins_estimator/odometry", 1, odom_cb);
...
void odom_cb(const nav_msgs::Odometry::ConstPtr& msg)
{
    ...
    if(cb_cnt / 10 < 30){
        X_des << 0, 0, 1, 0, 0, 0, 1, 0, 0.35, 0, 0, 0; 
        std::cout<<"3333333333333333333333333333333333"<<std::endl;

    }
    else{
        X_des << 5, 0, 1, 0, 0, 0, 1, 0, 0.5, 0, 0, 0; 
