...
geometry_msgs::PoseStamped WorldToBodyTransformer::transformToBodyFrame(const geometry_msgs::PoseStamped& world_pose) {
    ...
    Eigen::Vector3d body_position = TWfluWned * current_origin_orientation_.conjugate() * relative_position;
    ...
    // Eigen::Matrix3d world_rotation_matrix = world_orientation.toRotationMatrix();
    // Eigen::Matrix3d ned_rotation_matrix = TWfluWned * world_rotation_matrix;
    // Eigen::Quaterniond ned_orientation(ned_rotation_matrix);
    // Eigen::Quaterniond body_orientation = current_origin_orientation_.conjugate() * ned_orientation;
    ...
    // Eigen::Quaternion Q(world_pose.pose.orientation.w, world_pose.orientation.x, world_pose.pose.orientation.y, world_pose.pose.orientation.z);
